...
class _WeightTrackingPageState extends State<WeightTrackingPage> {
  ...
  Future<void> _loadRecords() async {
    final data = await HealthDatabase.instance.getRecords("weight");
  ...
  Future<void> _saveRecord() async {
    ...
    await HealthDatabase.instance.insertRecord("weight", weight, selectedDate);
        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFF5F51B4), Color(0xFF2196F3)],
            ),
          ),
        ),
        title: const Text(
  ...
  Widget _timelineCard(WeightRecord record) {
    return Container(
